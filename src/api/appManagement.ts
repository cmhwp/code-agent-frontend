...
/** 管理员删除应用 管理员删除指定应用 POST /app/admin/delete */
...
/** 管理员获取应用详情 管理员根据ID获取应用详细信息 GET /app/admin/get/vo */
...
/** 管理员应用列表 管理员分页获取应用列表 POST /app/admin/list/page/vo */
...
/** 管理员更新应用 管理员更新应用信息 POST /app/admin/update */
...
/** 对话生成代码 通过对话生成应用代码（流式响应） GET /app/chat/gen/code */
...
/** 删除应用 删除应用（用户只能删除自己的应用） POST /app/delete */
...
/** 应用部署 部署应用并返回访问URL POST /app/deploy */
...
/** 获取应用详情 根据ID获取应用详细信息 GET /app/get/vo */
...
/** 精选应用列表 分页获取精选应用列表 POST /app/good/list/page/vo */
...
/** 我的应用列表 分页获取当前用户创建的应用列表 POST /app/my/list/page/vo */
...
/** 更新应用 更新应用信息（用户只能更新自己的应用） POST /app/update */
